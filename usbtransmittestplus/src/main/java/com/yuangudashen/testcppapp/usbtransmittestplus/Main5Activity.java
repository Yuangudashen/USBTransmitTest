...
//        }
        ...
        textView.append("----------------------------------\n");
        textView.append("主机命令：-> "+String.format("%02x,%02x,%02x,%02x\n", ReadDataBuffer[0], ReadDataBuffer[1], ReadDataBuffer[2], ReadDataBuffer[3]));
        textView.append("按键状态：-> " + String.format("%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x\n", ReadDataBuffer[4], ReadDataBuffer[5], ReadDataBuffer[6], ReadDataBuffer[7], ReadDataBuffer[8], ReadDataBuffer[9], ReadDataBuffer[10], ReadDataBuffer[11]));
        textView.append("卡号信息：-> " + String.format("%02x,%02x,%02x,%02x,%02x,%02x,%02x,%02x\n", ReadDataBuffer[12], ReadDataBuffer[13], ReadDataBuffer[14], ReadDataBuffer[15], ReadDataBuffer[16], ReadDataBuffer[17], ReadDataBuffer[18], ReadDataBuffer[19]));
