    ...
    public class ConnectStateChanged implements USBTransmit.DeviceConnectStateChanged {
        ...
        public void stateChanged(boolean connected) {
            if (connected) {
                ...
                Toast.makeText(Main2Activity.this, "设备断开连接", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int devIndex = 0;
                int DataNum = 1;//单位为包 5000
                int PacketSize = 256;//每次传输的数据字节数，该参数必须和单片机中的参数完全匹配，该参数不能大于或等于64K
                ...
                textView.append("----------------------------------\n");
                textView.append("ReadDataBuffer = " + Arrays.toString(ReadDataBuffer)+"\n");
